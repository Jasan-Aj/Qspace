    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <!-- <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" class="size-2" /> -->
             <p class="text-xl text-white font-bold">Logo</p>
          </div>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <?php else : ?>
                <a href="login" class="bg-blue-900 rounded-lg shadow-lg shadow-black p-2 text-white font-bold" >Login</a>
              ...
              <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <form action="logout" method="post">
                  ...
                  <input class="block px-4 py-2 bg-white cursor-pointer text-sm text-gray-700" id="user-menu-item-2" type="submit" value="Sign out">
                </form>
              </div>
        ...
        <?php else: ?>
          <a href="login" class="bg-blue-900 rounded-lg shadow-lg shadow-black p-2 text-white font-bold md:hidden" >Login</a>
        <?php endif ?>
      </div>
    </div>
